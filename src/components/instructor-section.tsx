          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            <div>
              ...
              <p className="text-slate-300 mb-6">
                Desarrollador web con más de 5 años en el desarrollo en programación Web.
                Especializado en tecnologías frontend y backend, con
                pasión por la enseñanza y el desarrollo de interfaces de usuario
                modernas.
              </p>
                <p className="text-slate-300 mb-6">
                    He trabajado en proyectos para startups y empresas
                    consolidadas, siempre buscando la mejor experiencia de usuario
